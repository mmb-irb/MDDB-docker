...
⚠️ **Although all the steps of the installation and deployment are autometic, it's highly recommended to read all the documentation before running this script** ⚠️ 
